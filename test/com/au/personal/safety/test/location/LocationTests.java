...
public class LocationTests {
	...
	*/
	...
	/* 
	 * Test adding a new location entry to Location table
	 * Assumptions: UserID is not already in table
	 * End Result: New entry with entered latitude, longitude, and UserID  + current time as Time
	 *  + an autogenerated LocationID
	 * */
	@Test
	...
	/* 
	 * Test modifying a location in Location table for a specific UserID
	 * Assumptions: UserID is already in table; the entered latitude and longitude are different
	 *  from the current values
	 * End Result: Entry with specified UserID is modified for entered latitude and longitude + current time as Time
	 *  + unaltered LocationID and unaltered UserID
	 * */
	@Test
	...
	/* 
	 * Test modifying a location in Location table for a specific UserID with an unchanged latitude and unchanged longitude
	 * Assumptions: UserID is already in table; the entered latitude and longitude are the same
	 *  as the current values
	 * End Result: Entry with specified UserID is modified for current time as Time
	 *  + unaltered LocationID, UserID, Latitude, and Longitude
	 * */
	@Test
